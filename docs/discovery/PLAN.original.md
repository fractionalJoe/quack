# Quack Delivery Plan (original)

Superseded on 2026-09-13 by [PLAN.md](PLAN.md), which carries the unfinished work restructured as slices. `[-]` marks a step or criterion carried into that plan.
