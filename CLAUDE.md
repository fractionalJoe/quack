...
- NEVER run git commit or git push unless Human's current message says to commit or push. A plan step, an exit criterion, or the word "pushed" in a result is NOT that instruction. When in doubt, stop and ask.
