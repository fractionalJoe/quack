...
Minimal Slack-like chat on AWS (CDK, TypeScript). Meant to demonstrate the architecture and implementation of a minimal real-time messaging service. Channels are called flocks. PLAN.md is the working plan; work it top to bottom.
